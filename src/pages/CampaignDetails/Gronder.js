  ...
  return (
    <div className="page">
      ...
      <div className="campaignBox">
        <center>
          <h1>San Bernardino County Stormwater Public Education Program</h1>
          {/* <p>
        ...
        <center className="headerBox">
          ...
          <p className="headerParagraphs">
            {" "}
            <b>Authors: </b>S.Gronder Associates, Inc.
          </p>
          <hr />
          <p className="headerParagraphs">
          ...
          <hr />
          <p className="headerParagraphs">
            <b>Location: </b>San Bernardino County, California
          </p>
          <hr />
        </center>
        <hr />
        {selector === "0" && (
          <center>
            <h2>Abstract</h2>
            <p>
              This annual report discusses the 2012-2013 San Bernardino County
              Stormwater Program to reduce pollutants streaming to water bodies.
              One of the pollution prevention efforts is a residential pet waste
              campaign.
            </p>
          </center>
        )}
