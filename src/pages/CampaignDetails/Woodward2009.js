...
import pdf from "./CampaignPDF/Woodward2009.pdf";
      ...
      <div className="campaignBox">
        ...
        <center className="headerBox">
          ...
          <p className="headerParagraphs">
            {" "}
            <b>Authors: </b>Woodward, W., William F. Hunt, Wendi Hartup
          </p>
          <hr />
          <p className="headerParagraphs">
            <b>Published: </b>2009
          ...
          <hr />
          <p className="headerParagraphs">
            <b>Location: </b>North Carolina, specifically in Brunswick, Craven,
            Henderson, New Hanover, Transylvania, and Wake counties
          </p>
          <hr />
        </center>
        <hr />
        {selector === "0" && (
          <center>
            <h2>Abstract</h2>
            <p>
              To promote rain gardens and address the needs associated with
              educating homeowners and commercial landscape contractors on the
              benefits of rain gardens, their installation and maintenance
              rquirements, the North Carolina Backyard Rain Garden Program was
              implemented during the summer of 2006 in a six-county pilot area.
            </p>
          </center>
        )}
        {selector === "1" && (
