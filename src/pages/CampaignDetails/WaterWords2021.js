...
import pdf from "./CampaignPDF/WaterWords2021.pdf";
  ...
  return (
    <div className="page">
      ...
      <div className="campaignBox">
        <center>
          <h1>NCCDE Great Schools, Clean Streams 2021 Final Report</h1>
          {/* <p>
        ...
        <center className="headerBox">
          ...
          <p className="headerParagraphs">
            {" "}
            <b>Authors: </b>Water Words That Work, LLC
          </p>
          <hr />
          <p className="headerParagraphs">
            <b>Published: </b>2021
          ...
          <hr />
          <p className="headerParagraphs">
            <b>Location: </b>New Castle County, Delaware
          </p>
          <hr />
        </center>
        <hr />
        {selector === "0" && (
          <center>
            <h2>Abstract</h2>
            <p>
              Water Words That Work, LLC worked with the New Castle County
              Department of Special Services to run the Great Schools, Clean
              Streams social marketing campaign for the sixth time. The goal of
              the campaign was to persuade New Castle County residents to "can
              their grease" because grease contibutes to sewer overflows in the
              county.
            </p>
          </center>
        )}
