...
import pdf from "./CampaignPDF/Riggs2010.pdf";
  ...
  return (
    <div className="page">
      ...
      <div className="campaignBox">
        <center>
          <h1>Marketing for Behavior Change and Nutrient Reduction </h1>
          <p>
            Keywords: Low impact development, LID, education, outreach, social
            marketing, Blue Thumb, stormwater, BMP, best management practices,
        ...
        <center className="headerBox">
          ...
          <p className="headerParagraphs">
            {" "}
            <b>Authors: </b>J. Riggs, A. Hong, and J. Westerlund
          </p>
          <hr />
          <p className="headerParagraphs">
            <b>Published: </b>2010
        ...
        {selector === "0" && (
          <center>
            <h2>Abstract</h2>
            <p>
              This study discusses the Blue Thumb Program, which follows many
              social marketing strategies and helps the general public plant
              native gardens, raingardens, and shoreline plantings. The goal of
              the program is to address barriers that prevent people from
              planting for clean water. The program also uses incentives to
        ...
        {selector === "1" && (
          <center>
            ...
            <p>Plant native gardens, rain gardens, and shoreline plantings.</p>
        ...
        {selector === "4" && (
          <center>
            ...
            <p>
              The campaign kept track of retrofit projects and estimated
              nutrient load reductions in several watersheds.{" "}
            </p>
          </center>
        )}
        {selector === "5" && (
          <center>
            ...
            <p>
              One party held in 2007 resulted in 22 rain gardens. The 22 rain
              gardens translate to approximately 11 pounds of Phosphorus
              reduction, which is directly attributed to the marketing,
              technical assistance, and incentives provided. Similar results
              were found in 2008 and 2009.{" "}
            </p>
          </center>
        )}
        {selector === "6" && (
          <center>
            <h2>Incentive</h2>
            <p>
              Many program partners offer cost-share grants for water quality
              projects. Many also offer free home site visits (i.e. technical
              assistance) to help people choose the best landscaping option.
            </p>
          </center>
        )}
        {selector === "7" && (
