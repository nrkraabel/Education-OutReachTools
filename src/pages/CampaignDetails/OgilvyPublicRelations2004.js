...
import pdf from "./CampaignPDF/OgilvyPublicRelations2004.pdf";
  ...
  return (
    <div className="page">
      ...
      <div className="campaignBox">
        <center>
          <h1>Storm Water Pilot Test Evaluation</h1>
          {/* <p>
        ...
        <center className="headerBox">
          ...
          <p className="headerParagraphs">
            {" "}
            <b>Authors: </b>Ogilvy Public Relations Worldwide
          </p>
          <hr />
          <p className="headerParagraphs">
            <b>Published: </b>2004
          ...
          <hr />
          <p className="headerParagraphs">
            <b>Location: </b>Los Angeles County, California
          </p>
          <hr />
        </center>
        <hr />
        {selector === "0" && (
          <center>
            ...
            <p>
              ...
              commissioned Ogilvy Public Relations in 2003 and 2004 to design
              and implement a county-wide program to change resident's behavior,
              particularly throwing litter into appropriate containers.
            </p>
          </center>
        )}
        {selector === "1" && (
