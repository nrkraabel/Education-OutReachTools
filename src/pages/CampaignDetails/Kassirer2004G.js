...
import pdf from "./CampaignPDF/Kassirer2004G.pdf";
  ...
  return (
    <div className="page">
      ...
      <div className="campaignBox">
        <center>
          <h1>Community Program #7: North Central Texas</h1>
          {/* <p>
        ...
        <center className="headerBox">
          ...
          <hr />
          <p className="headerParagraphs">
            <b>Location: </b>North Central Texas
          </p>
          <hr />
        </center>
        <hr />
        {selector === "0" && (
          <center>
            <h2>Abstract</h2>
            <p>
              The Texas SmartScape Program took place in North Central Texas, a
              metropolitan region with 16 counties surrounding the urban center
              of Dallas and Fort Worth. The program aimed to educate residents
              about native vegetation that uses less water, pesticides, and
              fertilizer.
            </p>
          </center>
        )}
        {selector === "1" && (
          <center>
            ...
            <p>Reducing the use of pesticide, fertizer, and water</p>
        ...
        {selector === "4" && (
          <center>
            ...
            <p>
              Interviews with local garden centers and nurseries, environmental
              and water monitoring by Tarrant County Public Health, and customer
              demand for CDs.
            </p>
          </center>
        )}
        {selector === "5" && (
          <center>
            ...
            <p>
              Based on a small sample of organizations, participants and area
              garden centres, there had been a less than 10% decrease in
              pesticide usage. Tarrant County Public Health surveyed reductions
              in water and fertilizer usage and the early results suggested that
              phosphorus levels in stormwater were decreased by 5% since the
