...
import pdf from "./CampaignPDF/Frenzl2011.pdf";
  ...
  return (
    <div className="page">
      ...
      <div className="campaignBox">
        <center>
          <h1>Final Report: Snohomish County Septic System Program</h1>
          {/* <p>
        ...
        <center className="headerBox">
          ...
          <hr />
          <p className="headerParagraphs">
            <b>Location: </b>Snohomish County, Washington
          </p>
          <hr />
        </center>
        <hr />
        {selector === "0" && (
          <center>
            <h2>Abstract</h2>
            <p>
              In response to consistent presence of bacteria from human sources
              in county streams, Snohomish County Surface Water Management (SWM)
              applied for and received a Centennial Clean Water Fund grant from
              the Department of Ecology to address onsite septic system (OSS)
