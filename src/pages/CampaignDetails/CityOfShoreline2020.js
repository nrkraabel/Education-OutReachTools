...
import pdf from "./CampaignPDF/CityOfShoreline2020.pdf";
  ...
  return (
    <div className="page">
      ...
      <div className="campaignBox">
        <center>
          <h1>
            Soak It Up Rain Garden and Native Vegetation Landscaping Rebate
            Program Evaluation
          </h1>
          {/* <p>
        ...
        <center className="headerBox">
          ...
          <hr />
          <p className="headerParagraphs">
            <b>Location: </b>Shoreline, Washington
          </p>
          <hr />
        </center>
        <hr />
        {selector === "0" && (
          <center>
            <h2>Abstract</h2>
            <p>
              This evaluation uses social marketing research principals to
              investigate barriers to Soak It Up (SIU) program participation,
              perceived benefits that motivate participation, and explores
              attitudinal and demographic characteristics of interested and
