...
import pdf from "./CampaignPDF/StateWaterResources2004.pdf";
      ...
      <div className="campaignBox">
        ...
        <center className="headerBox">
          ...
          <p className="headerParagraphs">
            {" "}
            <b>Authors: </b>State Water Resources Control Board and Rogers &
            Associates
          </p>
          <hr />
          <p className="headerParagraphs">
        ...
        {selector === "0" && (
          <center>
            <h2>Abstract</h2>
            <p>
              To mitigate storm water pollution issues in Los Angeles County,
              the State Water Resources Control Board (SWRCB) in partnership
              with Rogers & Associates, implemented the "Erase the Waste" public
              education campaign.
            </p>
          </center>
        )}
